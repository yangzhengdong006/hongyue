				...
				<div class="content-box-content">
					...
					<div class="forms">
						...
						<fieldset> 
								...
								<p>
									<label>发货时间</label>
									<input class="text-input small-input datepicker inputDate" type="text" class="small-input" name="fatime" value="{$now}"  id="inputDate"/>
									<span class="input-notification success png_bg">必填</span>
								...
								<p>
									<label>预计到货时间</label>
									<input class="text-input small-input datepicker inputDate2" type="text" class="small-input" name="daotime" value="{$now}"  id="inputDate2"/>
									<span class="input-notification success png_bg">必填</span>
